//Task codewars id: 5613d06cee1e7da6d5000055
/* Task codewars description: The prime numbers are not regularly spaced. For example from `2` to `3` the step is `1`.
...
between the limits `m`, `n` if these g-steps prime numbers exist otherwise `nil` or `null` or `None` or `Nothing` or `[]` or `"0, 0"` or `{0, 0}` (depending on the language). 
